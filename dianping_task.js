...
function Dianping_task() {
    ...
    global.serverport = '8080';        //服务端接口
    global.proxymodel = 'default';     //代理模式，默认default, default 模式会用 global.http_proxy 设置的代理，其余模式需要用withProxy方法设置代理  ，dynamic 模式需要重写withProxy 获取代理
